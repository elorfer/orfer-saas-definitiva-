...
export default function WhatsAppButton() {
    const phoneNumber = "573123456789"; // I'll use a placeholder, user can change it
    ...
    return (
        ...
        >
            ...
            {/* Tooltip */}
            <span className="absolute right-full mr-4 bg-dark-card border border-white/10 text-gray-200 px-4 py-2 rounded-xl text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-2xl backdrop-blur-md">
