...
export default function Hero({ t, lang }: HeroProps) {
    ...
    return (
        <section className="relative min-h-screen flex items-center bg-black overflow-hidden pt-20 lg:pt-36 pb-40 lg:pb-52">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <button 
                            ...
                            className="w-full sm:w-auto bg-spotify-green hover:bg-[#1ed760] text-black font-black uppercase tracking-[0.1em] md:tracking-[0.2em] py-5 md:py-6 lg:py-5 px-8 md:px-16 lg:px-12 rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_20px_40px_rgba(29,185,84,0.4)] mb-8 md:mb-12 text-[13px] sm:text-base md:text-xl lg:text-lg leading-none flex items-center justify-center whitespace-nowrap"
                        >
