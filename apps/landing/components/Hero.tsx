...
export default function Hero({ t, lang }: HeroProps) {
    ...
    return (
        <section className="relative min-h-[90vh] md:min-h-screen flex items-center bg-black overflow-hidden pt-20 lg:pt-36 pb-12 lg:pb-32">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-start text-left w-full max-w-full overflow-hidden min-w-0"
                    >
                        ...
                        <div className="w-full max-w-full overflow-hidden mb-2 py-1 relative">
                        ...
                        <div className="flex flex-row gap-2 mb-6 w-full max-w-full overflow-hidden">
                            {/* Price Box */}
                        ...
                        <div className="w-full flex flex-col items-center md:items-start gap-6">
                            <button 
                                ...
                                className="w-full md:w-auto bg-spotify-green hover:bg-[#1ed760] text-black font-black uppercase tracking-[0.1em] md:tracking-[0.2em] py-4 md:py-5 px-8 md:px-12 rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_20px_40px_rgba(29,185,84,0.4)] text-[12px] md:text-lg flex items-center justify-center whitespace-nowrap"
                            >
...
function GenreTicker() {
    const genres = ["URBANO", "CORRIDOS", "SALSA", "POP", "BACHATA", "CRISTIANO", "Y MÁS"];
